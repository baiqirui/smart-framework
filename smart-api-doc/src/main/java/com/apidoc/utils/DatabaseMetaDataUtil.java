...
public class DatabaseMetaDataUtil
{
     ...
     * @param dataBaseName1
     */
    public static void init(String driver, String url1, String username1, String password1, String dataBaseName1)
    {
        // 初始化数据库连接信息
        url = url1;
        username = username1;
     ...
     */
    public static Map<String, TableDetail> getTablesDetails(String dataBaseName, String tableName)
        throws Exception
    {
        Connection conn = DriverManager.getConnection(url, username, password);
        ResultSet rs = null;
     ...
     * 利用表名和数据库用户名查询出该表对应的字段类型
     */
    public static Map<String, TableDetail> getTablesDetails2(DataSource dataSource, String tableName)
            throws Exception
    {
        ResultSet rs = null;
        Map<String, TableDetail> map = null;
