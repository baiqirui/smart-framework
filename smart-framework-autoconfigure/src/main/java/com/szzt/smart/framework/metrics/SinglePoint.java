...
public class SinglePoint
{
    ...
    private SinglePoint(Builder builder)
    {
        ...
        this.tagMap = Collections
            .unmodifiableMap(builder.tagMap == null ? new HashMap<String, String>() : builder.tagMap);
        this.fieldMap = Collections
            .unmodifiableMap(builder.fieldMap == null ? new HashMap<String, Object>() : builder.fieldMap);
